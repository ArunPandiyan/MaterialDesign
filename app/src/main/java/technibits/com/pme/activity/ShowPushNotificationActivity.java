...
import technibits.com.pme.helper.PrefManager;
import technibits.com.pme.model.Message;

/**
 * Created by technibitsuser on 7/28/2015.
 */


public class ShowPushNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_push_layout);
        ...
        if (email != null) {
            ParseUtils.subscribeWithEmail(RemindMe.returnMail());
        }else{
